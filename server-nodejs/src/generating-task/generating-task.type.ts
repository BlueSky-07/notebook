...
import { GeneratingTaskEntity, GeneratingTaskOutput, GeneratingTaskStatus } from "./generating-task.entity"
import { NodeEntity } from "../node/node.entity"
import { EdgeEntity } from "../edge/edge.entity"

export class GeneratingTaskInputInAddInput {
  @ApiProperty({ type: Number, isArray: true, description: 'generating from source nodes'  })
  sourceNodeIds: NodeEntity['id'][]

  @ApiProperty({ type: Number, isArray: true, description: 'generating from source edges'  })
...
export class GeneratingTaskPatchInput {
  ...
  @ApiProperty({ enum: GeneratingTaskStatus, enumName: 'GeneratingTaskStatusEnum' })
